...
.. If the application is not installed, see xref:reference:applicationReferences/mg-nsili.adoc#_installing_nsili[Installing NSILI] to install.
. Select *Configuration*.
. Select *NSILI Endpoint Configuration*.

include::reference:partial$nsili.endpoint.adoc[]
